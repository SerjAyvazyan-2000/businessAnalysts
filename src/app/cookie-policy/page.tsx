    ...
    return (
        <section className="py-20 px-6 max-w-5xl mx-auto">
            ...
            <div className="space-y-8 text-gray-700 text-[15px] leading-relaxed">
                <p>
                    This Cookie Policy explains how AU English Business Courses we, us, and our) uses
                    cookies and similar technologies to recognize you when you visit our website at
                    https://aubusinessenglish.com  Website . It explains what these technologies are and why
                ...
                <h2 className="text-2xl font-semibold mt-10 mb-4">2. Why do we use cookies?</h2>
                <p>
                    ...
                    interests of our users to enhance the experience on our Website. Third parties serve cookies
                    through our Website for analytics and other purposes.
                </p>

                <h2 className="text-2xl font-semibold mt-10 mb-4">3. How can you control cookies?</h2>
                <p>
                    You have the right to decide whether to accept or reject cookies. You can exercise your
                    cookie rights by setting your preferences in the Cookie Consent Banner. Essential cookies
                ...
                <h2 className="text-2xl font-semibold mt-10 mb-4">4. Updates to this policy</h2>
                <p>
                    ...
                    revisit this Cookie Policy regularly to stay informed about our use of cookies.
                </p>

                <h2 className="text-2xl font-semibold mt-10 mb-4">5. Where can you get more information?</h2>
                <p>
                    If you have any questions about our use of cookies or other technologies, please email us at{' '}
                    <a href="mailto:info@aubusinessenglish.com" className="text-blue-600 underline">
